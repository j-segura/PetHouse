...
class GeneroController extends Controller
{
    ...
    public function update(Request $request, Genero $genero)
    {
        ...
        return redirect()->route('admin.generos.edit', $genero)->with('info', 'El genero se actualizo con exito');
    }
    ...
    {
        $genero->delete();
        return redirect()->route('admin.generos.index')->with('info', 'EL genero se elimino con exito');
    }
}
